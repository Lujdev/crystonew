...
const snippets = {
  rates: "curl https://api.crystodolar.xyz/v1/rates",
  convert: "curl 'https://api.crystodolar.xyz/v1/convert?amount=100&from=USD&to=VES'",
  history: "curl 'https://api.crystodolar.xyz/v1/history/USD%2FVES?days=30'",
};
      ...
      <div>
        <section id="overview" className="docs-intro">
          ...
          <div className="docs-meta-grid">
            <div className="card docs-meta"><span>Base URL</span><strong>https://api.crystodolar.xyz</strong></div>
        ...
        <section id="endpoints" className="docs-section">
          ...
          <div className="endpoint-list">
            ...
            <article className="endpoint-card"><div className="endpoint-top"><span className="method">GET</span><code className="endpoint-path">/v1/status</code><span className="endpoint-description">Estado de fuentes</span></div><CodeBlock code="curl https://api.crystodolar.xyz/v1/status" /></article>
